...
#Readme
#NB. BC did not work. 
#Step 1: Load datasets UFP, BC, CS3, + make into dfs + same timestamp (in this case: between 10-08-2023 07:05:00 - 10-08-2023 10:58)
...
##cs3 
setwd("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/CS_AMS3/2023_08_10(No_construction)")
mypath <- "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/CS_AMS3/2023_08_10(No_construction)/"
...
###selects timeframe measured (07:05-13.00)
cs3 <- cs3[cs3$time_local >= "2023-08-10 07:05:00",]
cs3 <- cs3[cs3$time_local <= "2023-08-10 13:00:00",]
...
pred_10082023_pm25 <- predict(loaded_rf_pm25, cs3)
cs3$PM25_cs3 <- pred_10082023_pm25
summary(pred_10082023_pm25)

loaded_rf_no2 <- readRDS(file = "rf_CS3_no2.rds")
cs3$gas_op2_w_cs3 <- cs3$gas_op2_w
cs3$temperature_opc_cs3 <- cs3$temperature_opc
cs3$humidity_opc_cs3 <- cs3$humidity_opc
pred_10082023_no2 <- predict(loaded_rf_no2, cs3)
cs3$gas_op2_w_cs3 <- pred_10082023_no2
summary(pred_10082023_no2)

##UFP 
Partector <- read_delim("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/UFP/2023_08_10_(No_Construction)/8365_070435.txt", 
                        delim = "\t", escape_double = FALSE, 
                        trim_ws = TRUE, skip = 18) #trims off header lines
 
Partector_start=as_datetime("2023-08-10 07:04:51 CET")
Partector <- Partector %>%
...
##BC
ObservAirDST <- read_csv("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/BC_Julie/Data34_230810_07h11m_(no_construction_Filter_wrong)/Data34_2023-08-10.txt",
...
##UFP Plots
###Plot(UFP1: Whole sampling time 10 August 2023 UFP 
Partector_Filter <- Partector %>% filter(Part_time >= as_datetime("2023-08-10 07:05:00 CET") & Part_time <= as_datetime("2023-08-10 11:00:00 CET"))
...
UFP
###Plot_UFP2:whole sampling time period 10 August 2023 UFP - using viridis turbo
...
###Plot_UFP3:boxplot all period 10 August 2023 UFP, including mean 
mean_working <- mean(Partector$number)
summary(Partector_Filter$number)
ggplot(data = Partector, aes(x = Part_time, y = number)) +
  ...
  labs(
    x = "Time",
    y = "Number",
    title = "10 August 2023 - POST Rotterdam",
...
###Plot_UFP4:Geom_point plot 10 August 2023 UFP
...
Par_DST_join <-Par_DST_join %>%
  filter(Part_time >= as_datetime("2023-08-10 07:05:00 CET") & Part_time <= as_datetime("2023-08-10 11:00:00 CET") & GPSlat >= 51.0 & GPSlat <= 52.00 & GPSlong >= 4.48 & GPSlong <= 4.49)

POST10_UFP <- qmplot(data = Par_DST_join,  
                     x = GPSlong, y = GPSlat, 
                     geom = "blank", 
                     zoom = 18, 
                     maptype = "toner-lite", 
  ...
  labs(title = "Number map 17 August 2023", color = "Number")

POST10_UFP

##Plots for BC
###Plot_BC1: 
ObservAirDST <- ObservAirDST %>% filter(DST_time >= as_datetime("2023-08-10 7:05:00 CET") & DST_time <= as_datetime("2023-08-10 11:00:00 CET"))
...
ggplot(data = ObservAirDST, aes(x = DST_time, y = BC)) +
  ...
  labs(
    x = "Time",
    y = "BC",
    title = "10 August 2023 - POSTRotterdam",
...
ObservAirDST_filter <- ObservAirDST %>%
  filter(DST_time >= as_datetime("2023-08-10 07:05:00 CET") & DST_time <= as_datetime("2023-08-10 11:00:00 CET") & GPSlat >= 51.0 & GPSlat <= 52.00 & GPSlong >= 4.48 & GPSlong <= 4.9)
POST20_BC <- qmplot(data = ObservAirDST_filter,  
  ...
  labs(title = "BC map 10 August 2023", color = "BC") 
...
#write.csv(Partector, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/UFP_20230810_POST.CSV") 

POST_sampling + plot_annotation(title="POST Rotterdam 10-08-2023",
                                subtitle= "UFP & BC PM25 & NO2")

#write.csv(cs3, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs//CS_20230810_POST.CSV") 
#write.csv(Partector, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs//UFP_20230810_POST.CSV") 
#write.csv(ObservAirDST, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs//BC_20230810_POST.CSV") 
