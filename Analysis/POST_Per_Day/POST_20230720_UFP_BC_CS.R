...
#MR_20231003
#Readme
#Step 1: Load datasets UFP, BC, CS3, + make into dfs + same timestamp (in this case: between 20-07-2023 7:21 - 20-07-2023 10:58)
...
##cs3 
setwd("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/CS_AMS3/2023_07_20")
mypath <- "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/CS_AMS3/2023_07_20"
...
cs3 <- cs3[cs3$time_local >= "2023-07-20 7:19:00",]
cs3 <- cs3[cs3$time_local <= "2023-07-20 13:00:00",]
...
pred_20072023_pm25 <- predict(loaded_rf_pm25, cs3)
cs3$PM25_cs3 <- pred_20072023_pm25
summary(pred_20072023_pm25)

loaded_rf_no2 <- readRDS(file = "rf_CS3_no2.rds")
cs3$gas_op2_w_cs3 <- cs3$gas_op2_w
cs3$temperature_opc_cs3 <- cs3$temperature_opc
cs3$humidity_opc_cs3 <- cs3$humidity_opc
pred_20072023_no2 <- predict(loaded_rf_no2, cs3)
cs3$gas_op2_w_cs3 <- pred_20072023_no2
summary(pred_20072023_no2)

##UFP 
Partector <- read_delim("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/UFP/2023_07_20/8365_071905.txt", 
                        delim = "\t", escape_double = FALSE, 
                        trim_ws = TRUE, skip = 18) #trims off header lines
 
Partector_start=as_datetime("2023-07-20 07:19:21 CET")
Partector <- Partector %>%
...
##BC
ObservAirDST <- read_csv("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/BC_Julie/Data34_230720_07h09m/Data34_2023-07-20.txt", 
...
## Plots for UFP 
###Plot(UFP1: Whole sampling time 20 July 2023 UFP 
Partector_Filter <- Partector %>% filter(Part_time >= as_datetime("2023-07-20 07:21:00 CET") & Part_time <= as_datetime("2023-07-20 11:00:00 CET"))
...
UFP
###Plot_UFP2:whole sampling time period 20 July 2023 UFP - using viridis turbo
...
###Plot_UFP3:boxplot all period 20 July 2023 UFP, including mean 
...
ggplot(data = Partector, aes(x = Part_time, y = number)) +
  ...
  labs(
    x = "Time",
    y = "Number",
    title = "20 July 2023 - POST Rotterdam",
...
###Plot_UFP4:Geom_point plot 20 July 2023 UFP
...
Par_DST_join <-Par_DST_join %>%
  filter(Part_time >= as_datetime("2023-07-20 07:21:00 CET") & Part_time <= as_datetime("2023-07-20 11:00:00 CET") & GPSlat >= 51.0 & GPSlat <= 52.00 & GPSlong >= 4.48 & GPSlong <= 4.49)
...
POST20_UFP <- qmplot(data = Par_DST_join,  
  ...
  labs(title = "Number map 20 July 2023", color = "Number")

POST20_UFP

##Plots for BC
###Plot_BC1: 
#ObservAirDST <- ObservAirDST %>% filter(DST_time >= as_datetime("2023-07-17 7:21:00 CET") & DST_time <= as_datetime("2023-07-17 11:00:00 CET"))
...
ggplot(data = ObservAirDST, aes(x = DST_time, y = BC)) +
  ...
  labs(
    x = "Time",
    y = "BC",
    title = "20 July 2023 - POSTRotterdam",
...
ObservAirDST_filter <- ObservAirDST %>%
  filter(DST_time >= as_datetime("2023-07-20 07:21:00 CET") & DST_time <= as_datetime("2023-07-20 11:00:00 CET") & GPSlat >= 51.0 & GPSlat <= 52.00 & GPSlong >= 4.48 & GPSlong <= 4.9)
POST20_BC <- qmplot(data = ObservAirDST_filter,  
  ...
  labs(title = "BC map 20 July 2023", color = "BC") 
...
POST_sampling + plot_annotation(title="POST Rotterdam 20-07-2023",
...
#write.csv(cs3, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/CS_20230720_POST.CSV") 
#write.csv(Partector, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/UFP_20230720_POST.CSV") 
#write.csv(ObservAirDST, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs//BC_20230720_POST.CSV") 
