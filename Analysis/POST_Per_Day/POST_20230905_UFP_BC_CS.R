...
#MR_20231003
#Readme
#Step 1: Load datasets UFP, BC, CS3, + make into dfs + same timestamp (in this case: between 09-05-2023 7:17 - 05-09-0523 13:30)
...
##cs3 
setwd("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/CS_AMS3/2023_09_05(On-site)/")
mypath <- "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/CS_AMS3/2023_09_05(On-site)/"
...
###selects timeframe measured (07:17 -13.00)
cs3 <- cs3[cs3$time_local >= "2023-09-05 07:17:14",]
cs3 <- cs3[cs3$time_local <= "2023-09-05 13:30:00",]
...
pred_05092023_pm25 <- predict(loaded_rf_pm25, cs3)
cs3$PM25_cs3 <- pred_05092023_pm25
summary(pred_05092023_pm25)

loaded_rf_no2 <- readRDS(file = "rf_CS3_no2.rds")
cs3$gas_op2_w_cs3 <- cs3$gas_op2_w
cs3$temperature_opc_cs3 <- cs3$temperature_opc
cs3$humidity_opc_cs3 <- cs3$humidity_opc
pred_05092023_no2 <- predict(loaded_rf_no2, cs3)
cs3$gas_op2_w_cs3 <- pred_05092023_no2
summary(pred_05092023_no2)

##UFP 
Partector <- read_delim("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/UFP/2023_09_05/8365_071658.txt", 
                        delim = "\t", escape_double = FALSE, 
                        trim_ws = TRUE, skip = 18) #trims off header lines
 
Partector_start=as_datetime("2023-09-05 07:17:14 CET")
Partector <- Partector %>%
...
##BC
ObservAirDST <- read_csv("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/POST/BC_Julie/Data34_230905_06h55m/Data34_2023-09-05.txt", 
...
#step 2 - Time series all four sensors
## Plots for UFP 
###Plot(UFP1: Whole sampling time 05 Sept 2023 UFP 
Partector_Filter <- Partector %>% filter(Part_time >= as_datetime("2023-09-05 07:17:00 CET") & Part_time <= as_datetime("2023-09-05 13:30:00 CET"))
...
UFP
###Plot_UFP2:whole sampling time period 05 Sept 2023 UFP - using viridis turbo
ggplot(data = Partector_Filter, aes(x = Part_time, y = number, color = number)) +
  ...
  geom_rug() +
  xlim(as.POSIXct("2023-09-05 07:17:00 CET"), as.POSIXct("2023-09-05 13:30:00 CET")) +
  ylim(-1000, 180000) +
...
###Plot_UFP3:boxplot all period 05 Sept 2023 UFP, including mean 
...
ggplot(data = Partector, aes(x = Part_time, y = number)) +
  ...
  labs(
    x = "Time",
    y = "Number",
    title = "05 Sept 2023 - POST Rotterdam",
...
###Plot_UFP4:Geom_point plot 05 Sept 2023 UFP
...
Par_DST_join <-Par_DST_join %>%
  filter(Part_time >= as_datetime("2023-09-05 07:17:00 CET") & Part_time <= as_datetime("2023-09-05 11:17:00 CET") & GPSlat >= 51.0 & GPSlat <= 52.00 & GPSlong >= 4.48 & GPSlong <= 4.49)

POST20_UFP <- qmplot(data = Par_DST_join,  
                     x = GPSlong, y = GPSlat, 
                     geom = "blank", 
                     zoom = 18, 
                     maptype = "toner-lite", 
  ...
  labs(title = "Number map 17 Sept 2023", color = "Number")
...
##Plots for BC
###Plot_BC1: 
ObservAirDST <- ObservAirDST %>% filter(DST_time >= as_datetime("2023-09-05 7:17:00 CET") & DST_time <= as_datetime("2023-09-05 13:30:00 CET"))
...
BC <- ggplot(data=ObservAirDST, aes(x=DST_time, y=BC, color = BC)) +
  ...
  theme(legend.position = "none") +
  geom_rug() +
  #xlim(as_datetime("2023-09-05 06:35:00 CET"),as_datetime("2023-07-17 11:30:00 CET"))+
  ylim(0,20)  +
  scale_x_datetime(
    date_breaks = "10 mins",
    date_labels = "%H:%M"
...
ggplot(data = ObservAirDST, aes(x = DST_time, y = BC)) +
  ...
  labs(
    x = "Time",
    y = "BC",
    title = "05 Sept 2023 - POSTRotterdam",
...
ObservAirDST_filter <- ObservAirDST %>%
  filter(DST_time >= as_datetime("2023-09-05 07:21:00 CET") & DST_time <= as_datetime("2023-09-05 11:00:00 CET") & GPSlat >= 51.0 & GPSlat <= 52.00 & GPSlong >= 4.48 & GPSlong <= 4.9)
POST09_BC <- qmplot(data = ObservAirDST_filter,  
                    x = GPSlong, y = GPSlat, 
                    geom = "blank", 
                    zoom = 18, 
                    maptype = "toner-lite", 
  ...
  labs(title = "BC map 17 Sept 2023", color = "BC") 
...
#                        legend.key.width = unit(2, 'cm'), legend.text = element_text(size = 15), 
#                        legend.title = element_text(size =15)) + 
#   labs(title = "BC map 17 Sept 2023", color = "PM25") 
# 
# POST17_CS
...
POST_sampling + plot_annotation(title="POST Rotterdam 05-09-0523",
                                subtitle= "UFP & BC")
...
# 
# 
# # "2023-09-05 07:21:00", "2023-09-05 08:02:00"
# # "2023-09-05 08:09:00", "2023-09-05 8:42:00"
# # "2023-09-05 09:06:00", "2023-09-05 9:21:00"
# # "2023-09-05 09:21:00", "2023-09-05 9:50:00"
# # "2023-09-05 09:50:00", "2023-09-05 10:40:00"
# 
# intervals <- data.frame(
#   start = as.POSIXct(c("2023-09-05 07:21:00", "2023-09-05 08:09:00", "2023-09-05 09:06:00", "2023-09-05 09:21:00",  "2023-09-05 09:50:00"), tz = "Europe/Amsterdam"),
#   end = as.POSIXct(c("2023-09-05 08:02:00", "2023-09-05 8:42:00", "2023-09-05 9:21:00", "2023-09-05 9:50:00","2023-09-05 10:40:00"), tz = "Europe/Amsterdam"),
...
#write.csv(cs3, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs//CS_20230905_POST.CSV") 
#write.csv(Partector, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/UFP_20230905_POST.CSV") 
#write.csv(ObservAirDST, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs//BC_20230905_POST.CSV") 
