...
#MR_20231002
#Readme
#Step 1: Load datasets UFP, BC, CS3 + make into dfs + same timestamp (in this case: between 27-09-2023 06:31:00 - 27-09-2023 13:00)
...
##CS3
setwd("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/CS_AMS3/2023_09_27/")
mypath <- "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/CS_AMS3/2023_09_27/"
...
###selects timeframe measured (6.31-13.00)
cs3 <- cs3[cs3$time_local >= "2023-09-27 6:31:00",]
cs3 <- cs3[cs3$time_local <= "2023-09-27 13:00:00",]
...
pred_27092023_pm25 <- predict(loaded_rf_pm25, cs3)
cs3$PM25_cs3 <- pred_27092023_pm25
summary(pred_27092023_pm25)

loaded_rf_no2 <- readRDS(file = "rf_CS3_no2.rds")
cs3$gas_op2_w_cs3 <- cs3$gas_op2_w
cs3$temperature_opc_cs3 <- cs3$temperature_opc
cs3$humidity_opc_cs3 <- cs3$humidity_opc
pred_27092023_no2 <- predict(loaded_rf_no2, cs3)
cs3$gas_op2_w_cs3 <- pred_27092023_no2
summary(pred_27092023_no2)

##UFP 
Partector <- read_delim("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/UFP/2023_07_12/8365_081831.txt", 
                        delim = "\t", escape_double = FALSE, 
                        trim_ws = TRUE, skip = 18) #trims off header lines
 
###add time column
Partector_start=as_datetime("2023-09-27 06:30:46 CET")
Partector <- Partector %>%
...
##BC
ObservAirDST <- read_csv("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/BC_Julie/Data34_230712_08h17m/2023-07-12.txt", 
...
Partector_Filter <- Partector %>% filter(Part_time >= as_datetime("2023-09-27 06:31:00 CET") & Part_time <= as_datetime("2023-09-27 13:00:00 CET"))
...
ggplot(data = Partector, aes(x = Part_time, y = number)) +
  ...
  labs(
    x = "Time",
    y = "Number",
    title = "27 Sept 2023 - Switi Amsterdam",
...
###UFP_d:Geom_point plot 27 Sept 2023 UFP
...
Par_DST_join <-Par_DST_join %>%
  filter(Part_time >= as_datetime("2023-09-27 06:31:00 CET") & Part_time <= as_datetime("2023-09-27 13:00:00 CET") & GPSlat >= 52.3 & GPSlat <= 52.45 & GPSlong >= 4.75 & GPSlong <= 4.98)
...
Swi21_UFP <- qmplot(data = Par_DST_join,  
  ...
  labs(title = "Number map 27 Sept 2023", color = "Number")

Swi21_UFP

##Plots for BC
###BC_a: 
ObservAirDST <- ObservAirDST %>% filter(DST_time >= as_datetime("2023-09-27 6:31:00 CET") & DST_time <= as_datetime("2023-09-27 13:00:00 CET"))
...
ObservAirDST_filter <- ObservAirDST %>%
  filter(DST_time >= as_datetime("2023-09-27 06:31:00 CET") & DST_time <= as_datetime("2023-09-27 13:00:00 CET") & GPSlat >= 52.3 & GPSlat <= 52.45 & GPSlong >= 4.75 & GPSlong <= 4.98)
...
Swi21_BC <- qmplot(data = ObservAirDST_filter,  
  ...
  labs(title = "BC map 27 Sept 2023", color = "BC") 
...
#                        legend.key.width = unit(2, 'cm'), legend.text = element_text(size = 15), 
#                        legend.title = element_text(size =15)) + 
#   labs(title = "BC map 27 Sept 2023", color = "PM25") 
# Swi21_CS
...
Switi_sampling + plot_annotation(title="Switi Amsterdam 27-09-2023",
                                 subtitle= "UFP & BC")
...
#write.csv(cs3, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/CS_20230927_Switi.CSV") 
#write.csv(Partector, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/UFP_20230927_Switi.CSV") 
#write.csv(ObservAirDST, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/BC_20230927_Switi.CSV") 
