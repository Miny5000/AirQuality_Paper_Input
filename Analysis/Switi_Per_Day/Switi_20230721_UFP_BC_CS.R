...
#MR_20231002
#Readme
#Step 1: Load datasets UFP, BC, CS3, + make into dfs + same timestamp (in this case: between 21-07-2023 6:34 - 21-07-2023 11:30)
...
##cs3 
setwd("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/CS_AMS3/2023_07_21")
mypath <- "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/CS_AMS3/2023_07_21"
...
###selects timeframe measured (6.33-13.00)
cs3 <- cs3[cs3$time_local >= "2023-07-21 6:34:00",]
cs3 <- cs3[cs3$time_local <= "2023-07-21 11:30:00",]
...
pred_21072023_pm25 <- predict(loaded_rf_pm25, cs3)
cs3$PM25_cs3 <- pred_21072023_pm25
summary(pred_21072023_pm25)

loaded_rf_no2 <- readRDS(file = "rf_CS3_no2.rds")
cs3$gas_op2_w_cs3 <- cs3$gas_op2_w
cs3$temperature_opc_cs3 <- cs3$temperature_opc
cs3$humidity_opc_cs3 <- cs3$humidity_opc
pred_21072023_no2 <- predict(loaded_rf_no2, cs3)
cs3$gas_op2_w_cs3 <- pred_21072023_no2
summary(pred_21072023_no2)

##UFP 
Partector_a <- read_delim("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/UFP/2023_07_21/8365_063244.txt", 
                        delim = "\t", escape_double = FALSE, 
                        trim_ws = TRUE, skip = 18) #trims off header lines
 
Partector_start=as_datetime("2023-07-21 06:33:00 CET")
Partector_a  <- Partector_a  %>%
  mutate(Part_time = time + Partector_start)

Partector_b <- read_delim("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/UFP/2023_07_21/8365_110020.txt", 
                          delim = "\t", escape_double = FALSE, 
                          trim_ws = TRUE, skip = 18) #trims off header lines

Partector_start=as_datetime("2023-07-21 11:00:36 CET") 
...
##BC
ObservAirDST <- read_csv("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/BC_Julie/Data34_230721_06h20m/Data34_2023-07-21.txt", 
...
## Plots for UFP 
###UFP_a: Whole sampling time 21 July 2023 UFP 
...
UFP
###UFP_b:whole sampling time period 21 July 2023 UFP - using viridis turbo
ggplot(data = Partector, aes(x = Part_time, y = number, color = number)) +
  ...
  geom_rug() +
  xlim(as.POSIXct("2023-07-21 06:34:00 CET"), as.POSIXct("2023-07-21 11:30:00 CET")) +
  ylim(-1000, 180000) +
...
###UFP_c:boxplot all period 21 July 2023 UFP, including mean 
Partector_Filter <- Partector %>% filter(Part_time >= as_datetime("2023-07-21 06:34:00 CET") & Part_time <= as_datetime("2023-07-21 11:30:00 CET"))
...
ggplot(data = Partector, aes(x = Part_time, y = number)) +
  ...
  labs(
    x = "Time",
    y = "Number",
    title = "21 July 2023 - Switi Amsterdam",
...
###UFP_d:Geom_point plot 21 July 2023 UFP
...
Par_DST_join <-Par_DST_join %>%
  filter(Part_time >= as_datetime("2023-07-21 06:34:00 CET") & Part_time <= as_datetime("2023-07-21 11:30:00 CET") & GPSlat >= 52.3 & GPSlat <= 52.45 & GPSlong >= 4.75 & GPSlong <= 4.98)
...
##Plots for BC
###BC_a
ObservAirDST <- ObservAirDST %>% filter(DST_time >= as_datetime("2023-07-21 6:34:00 CET") & DST_time <= as_datetime("2023-07-21 11:30:00 CET"))
...
ggplot(data = ObservAirDST, aes(x = DST_time, y = BC)) +
  ...
  labs(
    x = "Time",
    y = "BC",
    title = "21 July 2023 - SwitiRotterdam",
...
ObservAirDST_filter <- ObservAirDST %>%
  filter(DST_time >= as_datetime("2023-07-21 06:34:00 CET") & DST_time <= as_datetime("2023-07-21 11:30:00 CET") & GPSlat >= 52.3 & GPSlat <= 52.45 & GPSlong >= 4.75 & GPSlong <= 4.98)
...
Swi21_BC <- qmplot(data = ObservAirDST_filter,  
  ...
  labs(title = "BC map 21 July 2023", color = "BC") 
...
PM25
###PM_b map 
Swi21_CS <- qmplot(data = cs3_filter,  
...
##NO2 General plot
NO2 <- ggplot(data=cs3_filter, aes(x=time_local, y=gas_op2_w_cs3, color = gas_op2_w_cs3)) +
  geom_line(color = "blue", size = 0.3) +
  theme_minimal()+
  labs(x = "Time", y = "NO2",
       title = "PM25",
...
Switi_sampling + plot_annotation(title="Switi Amsterdam 21-07-2023",
                                 subtitle= "UFP & BC")
...
#6.41-07.09 before starting. Though diesel generator is on.
#07.09-9.38 Working with crane, and manually
#09.38-10.11 Break
#10.11-11.27 working


# "2023-07-21 06:35:00", "2023-07-21 07:08:00"
# "2023-07-21 07:09:00", "2023-07-21 09:38:00"
# "2023-07-21 09:39:00", "2023-07-21 10:10:00"
# "2023-07-21 10:11:00", "2023-07-21 11:27:00"


intervals <- data.frame(
  start = as.POSIXct(c("2023-07-21 06:35:00", "2023-07-21 07:00:00", "2023-07-21 09:39:00", "2023-07-21 10:11:00"), tz = "Europe/Amsterdam"),
  end = as.POSIXct(c("2023-07-21 07:00:00", "2023-07-21 09:38:00", "2023-07-21 10:10:00", "2023-07-21 11:27:00"), tz = "Europe/Amsterdam"),
  label = c("Interval 1", "Interval 2", "Interval 3", "Interval 4")
)

intervals$start <- intervals$start + hours(2)
intervals$end <- intervals$end + hours(2)

intervals$label <- factor(intervals$label, levels = c("Interval 1", "Interval 2", "Interval 3", "Interval 4"))
...
Switi_sampling <- Interval / Interval2
Switi_sampling + plot_annotation(title="Switi Amsterdam 21-07-2023",
                                 subtitle= "UFP & BC-breaks")
...
#step 5 - Combine and write dfs
#write.csv(cs3, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/CS_20230721_Switi.CSV") 
#write.csv(Partector, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/UFP_20230721_Switi.CSV") 
#write.csv(ObservAirDST, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/BC_20230721_Switi.CSV") 
