...
#MR_20231002
#Readme
#Step 1: Load datasets UFP, BC, CS3 + make into dfs + same timestamp (in this case: between 12-07-2023 08:18:48 - 12-07-2023 13:00)
...
##CS3
setwd("C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/CS_AMS3/2023_07_12")
mypath <- "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Switi/CS_AMS3/2023_07_12"
...
###selects timeframe measured (8.20-13.00)
cs3 <- cs3[cs3$time_local >= "2023-07-12 8:25:00",]
cs3 <- cs3[cs3$time_local <= "2023-07-12 13:00:00",]
...
pred_12072023_pm25 <- predict(loaded_rf_pm25, cs3)
cs3$PM25_cs3 <- pred_12072023_pm25
summary(pred_12072023_pm25)

loaded_rf_no2 <- readRDS(file = "rf_CS3_no2.rds")
cs3$gas_op2_w_cs3 <- cs3$gas_op2_w
cs3$temperature_opc_cs3 <- cs3$temperature_opc
cs3$humidity_opc_cs3 <- cs3$humidity_opc
pred_12072023_no2 <- predict(loaded_rf_no2, cs3)
cs3$gas_op2_w_cs3 <- pred_12072023_no2
summary(pred_12072023_no2)
...
###add time column
Partector_start=as_datetime("2023-07-12 08:18:48 CET")
Partector <- Partector %>%
...
Switi_sampling + plot_annotation(title="Switi Amsterdam 12-07-2023",
                                 subtitle= "UFP & BC")
...
#write.csv(cs3, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/CS_20230712_Switi.CSV") 
#write.csv(Partector, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/UFP_20230712_Switi.CSV") 
#write.csv(ObservAirDST, "C:/Users/Miny Rajiv/OneDrive - AMS-Institute/Data/Analysis/Cleaned_dfs/BC_20230712_Switi.CSV") 
